...
| B-11 | `test/evals/` does not exist — the audit's item 8. Needs ≥3 behavioural scenarios per skill, a trigger set whose negatives are near-misses, and coexistence checked against the research/SEO skills already installed beside these two | run 7 | 2 | 2 | 0 | 1.0 | open |
