...
| B-04 | `GET /api/v1/wallet/balance` answers `404` and the published `prowl wallet` calls it. Either the route ships or the verb goes. Upstream: `PROWL-AI/prowl-cli` | run 3 | 2 | 1 | 0 | 2.0 | open, upstream |
